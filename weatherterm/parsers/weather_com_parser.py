...
from weatherterm.core import ForecastType, Mapper
...
class WeatherComParser:
    def __init__(self):
        ...
        self._only_digits_regex = re.compile(r'[0-9]+')
        self._unit_converter = UnitConverter(parser_default_unit=Unit.FAHRENHEIT)
    ...
    def _five_and_ten_days_forecast(self, args):
        ...
        result = self._parse_list_forecast(content, args)
        return self._prepare_data(result, args)
    ...
    def _weekend_forecast(self, args):
        ...
        container = forecast_data.div.div.div
